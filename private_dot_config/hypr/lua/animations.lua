...
-- smoothly on its own. Kept short (~150ms) so the step count stays low
-- enough to be imperceptible instead of disabling it outright.
hl.animation({ leaf = "fadeDim",     enabled = true, speed = 1.5, bezier = "default" })
